...
public class OI {
	...
	public static final int FORWARD_PNEUMATICS = 1;
	public static final int BACKWARD_PNEUMATICS = 2;
	public static final int OFF_PNEUMATICS = 11;
	...
	public OI() {
		...
		JoystickButton pistonOutButton = new JoystickButton(gamepad, FORWARD_PNEUMATICS);
		JoystickButton pistonInButton = new JoystickButton(gamepad, BACKWARD_PNEUMATICS);
		JoystickButton pistonOffButton = new JoystickButton(gamepad, OFF_PNEUMATICS);
